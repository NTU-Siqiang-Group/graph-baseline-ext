...
SG_INPUT_FILE = {
    ...
    "wikitalk": {
        "delim": join(DATA_ROOT, "wikitalk/wikitalk.txt"),
        "binary": join(DATA_ROOT, "wikitalk/wikitalk.bin"),
    },
    "citpatents": {
        "delim": join(DATA_ROOT, "citpatents/citpatents.txt"),
        "binary": join(DATA_ROOT, "citpatents/citpatents.bin"),
    }
}
...
SG_GRAPH_SETTINGS_DELIM = {
    ...
    "wikitalk": {"count_vertices": 2394385, "delimiter": SG_DELIM_SPACE, "use_original_ids": True},
    "citpatents": {"count_vertices": 3774769, "delimiter": SG_DELIM_SPACE, "use_original_ids": True},
}
